                    ...
                    <div className='text-wrapper w-full'>
                        ...
                        <div className='portofolio-wrapper'>
                            <div className='portofolio-item'>
                                <Image src="/pusdiklat.png" alt="portofolio-image" className='portofolio-image' />
                            ...
                            <div className='portofolio-item'>
                                <Image src="/sobatutbk.png" alt="portofolio-image" className='portofolio-image' />
                        ...
                        <div className='portofolio-wrapper'>
                            <div className='portofolio-item'>
                                <Image src="/selomerto.png" alt="portofolio-image" className='portofolio-image' />
                            ...
                            <div className='portofolio-item'>
                                <Image src="/pmbakn.png" alt="portofolio-image" className='portofolio-image' />
                        ...
                        <div className='portofolio-wrapper'>
                            <div className='portofolio-item'>
                                <Image src="/ikan.png" alt="portofolio-image" className='portofolio-image' />
                            ...
                            <div className='portofolio-item'>
                                <Image src="/kayu.png" alt="portofolio-image" className='portofolio-image' />
